<div {{ $attributes->class(['filament-tables-search-input']) }}>
    ...
    <div class="relative group">
        ...
        <input
            ...
            type="search"
            autocomplete="off"
            class="block w-full h-9 pl-9 placeholder-gray-400 transition duration-75 border-gray-200 rounded-md shadow-sm focus:border-primary-600 focus:ring-1 focus:ring-inset focus:ring-primary-600"
        >
    </div>
</div>
