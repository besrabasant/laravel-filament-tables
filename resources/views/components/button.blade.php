...
@php
    $buttonClasses = [
        'inline-flex items-center justify-center font-medium tracking-tight transition rounded focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset',
