...
return [
    ...
    'pagination' => [
        ...
        'overview' => 'Exibindo&nbsp;<strong class="text-gray-800">:first</strong>&nbsp;a&nbsp;<strong class="text-gray-800">:last</strong>&nbsp;de&nbsp;<strong class="text-gray-800">:total</strong>&nbsp;resultados',
